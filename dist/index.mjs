...
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(2430);
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(2186);



if (!_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('PTE_PANEL_URL')) {
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.error('No pterodactyl URL was supplied');
    process.exit(1);
}
if (!_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('PTE_BEARER_TOKEN')) {
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.error('No pterodactyl bearer token was supplied');
    process.exit(1);
}
if (!_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('PTE_PANEL_ID')) {
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.error('No pterodactyl panel ID was supplied');
    process.exit(1);
}

const url = `${_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('PTE_PANEL_URL')}/api/client/servers/${_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('PTE_PANEL_ID')}/power`;
await (0,got__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(url, {
    headers: {
        'Authorization': `Bearer ${_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput(PTE_BEARER_TOKEN)}`,
